 ...
 */
class OfflineCustomNotificationActivity : AppCompatActivity() {
    ...
    fun onDownloadRegion() {
        ...
        val notificationOptions = NotificationOptions.builder(this)
                .smallIconRes(R.drawable.ic_save)
                .cancelText("Custom cancel: ")
                .contentTitle("Custom downloading: ")
                .requestMapSnapshot(false)
                .returnActivity(OfflineCustomNotificationActivity::class.java.name)
                .build()
